...
MADtwissColumns['beta'] = ["NAME", "KEYWORD", "PARENT", "S", "L",  "BETX", "BETY"]
MADtwissColumns['coords'] = ["NAME", "KEYWORD", "PARENT", "S", "L", "X", "PX", "Y", "PY", "T", "PT"]
...
MADtwissColumns["CTE"] = ["NAME", "S", "L", "BETX", "BETY", "ALFX", "ALFY", "DX", "DPX", "DY", "DPY", "ANGL", "K1L",
                          "K1S"]
